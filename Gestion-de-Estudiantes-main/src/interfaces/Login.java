...
public class Login extends javax.swing.JFrame {
    ...
    private boolean verificarLogin() throws SQLException {
        ...
        JSONObject response = cliente.postJSON("https://proyectosuta.000webhostapp.com/aos_proyecto/models/login.php", requestBody);
    ...
    private void initComponents() {
        ...
        jlblLateral.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/fondoIDK.png"))); // NOI18N
