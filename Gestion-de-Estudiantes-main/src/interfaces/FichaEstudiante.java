...
public class FichaEstudiante extends javax.swing.JPanel {
    
    Estudiante estudiante;

    public FichaEstudiante(Estudiante estudiante) {
        initComponents();
    ...
    private void fillFields() {
        ...
        txtNombre.setText(String.format("%s %s", estudiante.getNombre(), estudiante.getApellido()));
    ...
    private void bkFichaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bkFichaMouseClicked
        Principal.seleccionarRegistro(estudiante.getCedula());
