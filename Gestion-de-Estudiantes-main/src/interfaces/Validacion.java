...
public class Validacion {
    ...
    public static boolean validarClave(String clave) {
        Pattern pattern = Pattern.compile("^(?=\\w*\\d)(?=\\w*[A-Z])(?=\\w*[a-z])\\S{4,30}$");
    ...
    public static boolean validarCedula(String cedula) {
        ...
        int oddSum = 0;
        int pairsSum = 0;
        int provinceCode = Integer.parseInt(cedula.substring(0, 2));//Generamos el código de provincia como entero.
        ...
        if ((Integer.valueOf(cedula.charAt(2)) - 48) <= 6 && ((provinceCode >= 1 && provinceCode <= 24) || provinceCode == 30)) {
            ...
            if (checkDigit == (Integer.parseInt(cedula.charAt(9) + ""))) {//Se compara el último resultado con el último dígito de la cédula.
                return true;
            }
        }
        return false;
